      ...
      <div className=" flex gap-4 font-normal text-xl cursor-pointer">
        ...
        >
          ...
          <motion.div
            ...
            className={` absolute ${
              hover == false ? "hidden" : ""
            }  mt-1 ml-[1vw] w-[24vw] h-[50vh] bg-[#FFFFFF] rounded-3xl p-3 `}
          >
            <div className="flex  w-full gap-5  p-3 hover:bg-yellow-50 rounded-lg">
              <img className="w-[30%]" src={servier} alt="" />
              <div className="w-60% flex flex-col gap-2">
                <h1 className="text-lg font-sans  font-semibold ">For Service</h1>
                <p className="text-xs">Lorem ipsum dolor sit amet consectetur adipisicing Lorem ipsum dolor sit amet.</p>
              </div>
            </div>
            <div className="flex w-full gap-5 p-3 hover:bg-yellow-50 rounded-lg">
              <img className="w-[40%]" src={subservicers} alt="" />
              <div className="w-60% flex flex-col gap-2">
                <h1 className="text-lg font-sans  font-semibold ">For Subservice</h1>
                <p className="text-xs">Lorem ipsum dolor sit amet consectetur adipisicing Lorem ipsum dolor sit amet.</p>
              </div>
            </div>
            <div className="flex w-full gap-5 p-3 hover:bg-yellow-50 rounded-lg">
              ...
              <div className="w-60% flex flex-col gap-2">
                <h1 className="text-lg font-sans  font-semibold ">For Lenders</h1>
                <p className="text-xs">Lorem ipsum dolor sit amet consectetur adipisicing Lorem ipsum dolor sit amet.</p>
              </div>
            </div>
          </motion.div>
        ...
        >
          ...
          <motion.div
            ...
            } mt-1  ml-[2vw] w-[24vw] h-[50vh] bg-[#FFFFFF] rounded-3xl grid grid-rows-3 `}
          >
            <div className="flex w-full">
              <img className="w-[40%]" src={servier} alt="" />
              <div className="w-60%">
                <h1>fggg</h1>
              </div>
            </div>
